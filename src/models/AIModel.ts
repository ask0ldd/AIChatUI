...
import { IEmbeddingResponse } from "../types/IEmbeddingResponse"
import { ICompletionResponse } from "../types/OllamaResponseTypes"
...
export class AIModel{
    ...
    async ask(prompt : string) : Promise<ICompletionResponse> {
        try {
            ...
            if(this.#discardThinking) responseAsJSON.response = this.#discardThinkingSequence(responseAsJSON.response)
